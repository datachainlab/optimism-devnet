module github.com/datachainlab/optimism-devnet/devnet
...
// Fix path-compression version for api/golang v1.18.1 compatibility
replace github.com/kurtosis-tech/kurtosis/path-compression => github.com/kurtosis-tech/kurtosis/path-compression v0.0.0-20260415082123-93f48a3fcaa4
